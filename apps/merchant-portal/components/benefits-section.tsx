...
export function BenefitsSection() {
  ...
  return (
    <section id="benefits" className="py-16 px-6 bg-black/50">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
          JPay offers significant advantages over traditional payment gateways, providing faster, cheaper, and more
          secure transactions.
        </p>
